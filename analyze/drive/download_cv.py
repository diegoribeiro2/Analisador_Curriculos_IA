...
folder_id = '1qJEAtzk63dS7TUQc-rWrkmrZyZOMuAeH'  # coloco aqui o ID da pasta onde estao os curriculos, fica na url depois de folders
...
if not files:
    raise FileNotFoundError('No files found in results.')
else:
    print('Files:')
    for file in files:
